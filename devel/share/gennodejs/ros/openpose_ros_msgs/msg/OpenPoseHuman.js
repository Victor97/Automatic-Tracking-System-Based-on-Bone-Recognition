...
class OpenPoseHuman {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.person_id, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.person_id = _deserializer.int32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '88dd89c154faccc47aaa9d7d382a9895';
  }
