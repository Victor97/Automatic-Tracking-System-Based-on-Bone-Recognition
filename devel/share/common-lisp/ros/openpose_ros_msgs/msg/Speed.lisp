...
(cl:defmethod cl:initialize-instance :after ((m <Speed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Speed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openpose_ros_msgs-msg:<Speed> is deprecated: use openpose_ros_msgs-msg:Speed instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Speed>))
