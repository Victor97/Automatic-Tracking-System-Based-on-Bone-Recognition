...
class OpenPoseHuman(genpy.Message):
  _md5sum = "88dd89c154faccc47aaa9d7d382a9895"
  _type = "openpose_ros_msgs/OpenPoseHuman"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """int32 person_id
...
float64 prob
"""
  __slots__ = ['person_id','num_body_key_points_with_non_zero_prob','num_face_key_points_with_non_zero_prob','num_right_hand_key_points_with_non_zero_prob','num_left_hand_key_points_with_non_zero_prob','face_bounding_box','body_key_points_with_prob','face_key_points_with_prob','right_hand_key_points_with_prob','left_hand_key_points_with_prob']
  _slot_types = ['int32','int32','int32','int32','int32','openpose_ros_msgs/BoundingBox','openpose_ros_msgs/PointWithProb[25]','openpose_ros_msgs/PointWithProb[70]','openpose_ros_msgs/PointWithProb[21]','openpose_ros_msgs/PointWithProb[21]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       person_id,num_body_key_points_with_non_zero_prob,num_face_key_points_with_non_zero_prob,num_right_hand_key_points_with_non_zero_prob,num_left_hand_key_points_with_non_zero_prob,face_bounding_box,body_key_points_with_prob,face_key_points_with_prob,right_hand_key_points_with_prob,left_hand_key_points_with_prob
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5i4d().pack(_x.person_id, _x.num_body_key_points_with_non_zero_prob, _x.num_face_key_points_with_non_zero_prob, _x.num_right_hand_key_points_with_non_zero_prob, _x.num_left_hand_key_points_with_non_zero_prob, _x.face_bounding_box.x, _x.face_bounding_box.y, _x.face_bounding_box.width, _x.face_bounding_box.height))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.person_id, _x.num_body_key_points_with_non_zero_prob, _x.num_face_key_points_with_non_zero_prob, _x.num_right_hand_key_points_with_non_zero_prob, _x.num_left_hand_key_points_with_non_zero_prob, _x.face_bounding_box.x, _x.face_bounding_box.y, _x.face_bounding_box.width, _x.face_bounding_box.height,) = _get_struct_5i4d().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_5i4d = None
def _get_struct_5i4d():
    global _struct_5i4d
    if _struct_5i4d is None:
        _struct_5i4d = struct.Struct("<5i4d")
    return _struct_5i4d
_struct_3d = None
def _get_struct_3d():
    global _struct_3d
