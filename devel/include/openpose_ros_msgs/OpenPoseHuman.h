...
struct OpenPoseHuman_
{
  ...
  (void)_alloc;
   ...
   typedef int32_t _person_id_type;
...
struct MD5Sum< ::openpose_ros_msgs::OpenPoseHuman_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x88dd89c154faccc4ULL;
  static const uint64_t static_value2 = 0x7aaa9d7d382a9895ULL;
};
...
struct Printer< ::openpose_ros_msgs::OpenPoseHuman_<ContainerAllocator> >
{
  ...
  {
    s << indent << "person_id: ";
    Printer<int32_t>::stream(s, indent + "  ", v.person_id);
